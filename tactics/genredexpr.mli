...
type raw_red_expr = (r_trm, r_cst, r_pat, r_cst * (int * int option) option, int Locus.or_var) red_expr_gen
...
type glob_red_expr = (g_trm, g_cst, g_trm, Names.GlobRef.t * (int * int option) option, int Locus.or_var) red_expr_gen
