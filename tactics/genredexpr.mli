...
type ('a, 'b, 'c, 'd, 'occvar, 'flags) red_expr_gen0 =
  | Red
  | Hnf
  | Step of ('d, 'b, 'occvar) Step.reduction
...
type ('a, 'b, 'c, 'd, 'occvar) red_expr_gen =
  ('a, 'b, 'c, 'd, 'occvar, 'b glob_red_flag) red_expr_gen0
...
type raw_red_expr = (r_trm, r_cst, r_pat, r_cst * int Locus.or_var option, int Locus.or_var) red_expr_gen
...
type glob_red_expr = (g_trm, g_cst, g_trm, Names.GlobRef.t * int Locus.or_var option, int Locus.or_var) red_expr_gen
