...
module Intern : sig
  ...
  val intern_red_expr : ('a,'b,'c) intern_env -> raw_red_expr -> ('a,'b,'c, GlobRef.t * int Locus.or_var option, int Locus.or_var) red_expr_gen
...
module Interp : sig
  ...
  val interp_red_expr : ('constr,'evref,'pat) interp_env -> Environ.env -> Evd.evar_map
    -> ('constr,'evref,'pat,GlobRef.t * int Locus.or_var option,int Locus.or_var) red_expr_gen -> Evd.evar_map * red_expr
